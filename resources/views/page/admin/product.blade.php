...
@section('content-web')
                                            ...
                                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-4 md:p-5 space-y-4">
                                                        <div class="grid grid-cols-3 text-black-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <button data-modal-hide="view-modal-{{ $product->id }}"
                                                            type="button"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal-hide="edit-modal-{{ $product->id }}">
                                                            <svg class="w-3 h-3" aria-hidden="true"
                                                                xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                viewBox="0 0 14 14">
                                                                <path stroke="currentColor" stroke-linecap="round"
                                                    ...
                                                    <div class="p-4 md:p-5">
                                                        <form action="{{ route('product.updates', $product->id) }}"
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="text" name="name" id="name"
                                                                    ...
                                                                    placeholder="Type your product" required />
                                                            </div>
                                                            <div>
                                                                <label for="price"
    ...
    {{-- Create Modal --}}
@section('title-modal-create', 'Create New Product')
@section('content-modal-create')
    <form action="{{ route('product.creates') }}" method="POST" class="p-4 md:p-5" enctype="multipart/form-data">
        @csrf
        <div class="grid gap-4 mb-4 grid-cols-2">
            ...
            <div class="col-span-2">
                ...
                <input type="file" name="image" id="image"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-2.5 py-0 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="$2999" required="">
            </div>
        </div>
        <button type="submit"
