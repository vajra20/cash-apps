                                        ...
                                        <tr>
                                            ...
                                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                <div class="flex items-center space-x-3.5">
                                                    ...
                                                    <!-- Main modal -->
                                                    <div id="view-modal-{{ $user->id }}" tabindex="-1"
                                                        aria-hidden="true"
                                                    ...
                                                    <button class="hover:text-primary"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            height="20" viewBox="0 0 24 24" class="fill-current">
                                                            ...
                                                            <g fill="none" stroke="currentColor"
                                                                ...
                                                                <path
                                                                    d="M18.375 2.625a2.121 2.121 0 1 1 3 3L12 15l-4 1l1-4Z" />
                                                            </g>
                                                        </svg>
                                                    </button>
                                                        ...
                                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="p-4 md:p-5">
                                                                    <form
                                                                        action="{{ route('register.updates', $user->id) }}"
                                                    ...
                                                    <div id="delete-modal-{{ $user->id }}" tabindex="-1"
                                                        ...
                                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                                            <div
                                                                ...
                                                                <form action="{{ route('register.deletes', $user->id) }}"
                                                                    method="POST">
                                                                    @csrf
