        ...
        <div class="relative flex flex-1 flex-col ">
            ...
            <main>
                <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                    ...
                    <!-- ====== Forms Section Start -->
                    <div
                        class="rounded-sm border border-stroke bg-box shadow-default dark:border-strokedark dark:bg-boxdark">
                        <div class="flex flex-wrap items-center">
                            <div class="hidden sm:w-full xl:block xl:w-1/2">
                            ...
                            <div class="sm:w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                                <div class="sm:w-full sm:p-12.5 xl:p-17.5">
                                    <h2 class="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                        Sign Up to Kasir
                                    </h2>

                                    <form action="{{ route('register.stores') }}" method="POST">
                                        @csrf
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-5">
                                            <input type="submit" value="Create account"
                                                class="w-full cursor-pointer rounded-lg border border-primary bg-blue-500 p-4 font-medium text-white transition hover:bg-opacity-90" />
                                        </div>
